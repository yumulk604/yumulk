...
class LoadingWindow(ui.ScriptWindow):
	...
	def Open(self):
		...
		imgFileNameDict = {
			0 : uiScriptLocale.LOCALE_UISCRIPT_PATH + "loading/background_loading_assassin.sub",
			1 : uiScriptLocale.LOCALE_UISCRIPT_PATH + "loading/background_loading_assassin2.sub",
			2 : uiScriptLocale.LOCALE_UISCRIPT_PATH + "loading/background_loading_assassin3.sub",
			3 : uiScriptLocale.LOCALE_UISCRIPT_PATH + "loading/background_loading_samahi1.sub",
			4 : uiScriptLocale.LOCALE_UISCRIPT_PATH + "loading/background_loading_shaman.sub",
			5 : uiScriptLocale.LOCALE_UISCRIPT_PATH + "loading/background_loading_sura.sub",
			6 : uiScriptLocale.LOCALE_UISCRIPT_PATH + "loading/background_loading_sura2.sub",
			7 : uiScriptLocale.LOCALE_UISCRIPT_PATH + "loading/background_loading_warrior.sub",
			8 : uiScriptLocale.LOCALE_UISCRIPT_PATH + "loading/background_loading_warrior5.sub",
			9 : uiScriptLocale.LOCALE_UISCRIPT_PATH + "loading/background_loading_warriorghist1.sub",
		}
