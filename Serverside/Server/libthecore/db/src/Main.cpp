...
int Start()
{
	...
	do
	{
		if (CDBManager::instance().Connect(SQL_PLAYER, "localhost", 0, "player", "root", "dev"))
		{
			sys_log(0, "   OK");
			break;
		}
	...
	do
	{
		if (CDBManager::instance().Connect(SQL_ACCOUNT, "localhost", 0, "account", "root", "dev"))
		{
			sys_log(0, "   OK");
			break;
		}
	...
	do
	{
		if (CDBManager::instance().Connect(SQL_COMMON, "localhost", 0, "common", "root", "dev"))
		{
			sys_log(0, "   OK");
			break;
		}
	...
	do
	{
		if (CDBManager::instance().Connect(SQL_HOTBACKUP, "localhost", 0, "hotbackup", "root", "dev"))
		{
			sys_log(0, "   OK");
			break;
		}
