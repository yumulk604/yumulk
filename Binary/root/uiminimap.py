...
class AtlasWindow(ui.ScriptWindow):
	...
	def LoadWindow(self):
		...
		self.board.SetMouseRightButtonDownEvent(ui.__mem_func__(self.GoToLocalPosition))
		self.Hide()
...
class MiniMap(ui.ScriptWindow):
	...
	def __LoadWindow(self):
		...
		try:
			...
			self.canalCurent = self.GetChild("CanalCurent")
		except:
			import exception
		...
		self.canalCurent.SetText("Canal %d" % constInfo.CANAL_CURENT)
