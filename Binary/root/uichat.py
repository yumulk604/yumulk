...
class ChatWindow(ui.Window):
	...
	def __init__(self):
		...
		btnClearChat = ui.Button()
		btnClearChat.SetParent(self)
		btnClearChat.SetUpVisual("d:/ymir work/ui/game/taskbar/Clear_Chat_Button_01.sub")
		btnClearChat.SetOverVisual("d:/ymir work/ui/game/taskbar/Clear_Chat_Button_02.sub")
		btnClearChat.SetDownVisual("d:/ymir work/ui/game/taskbar/Clear_Chat_Button_03.sub")
		btnClearChat.SetToolTipText(localeInfo.CHAT_CLEAR)
		btnClearChat.SetEvent(lambda : chat.ClearChat())
		btnClearChat.Hide()
		self.btnClearChat = btnClearChat
	...
	def OpenChat(self):
		...
		self.btnClearChat.SetPosition(self.GetWidth() - 75, 2)
