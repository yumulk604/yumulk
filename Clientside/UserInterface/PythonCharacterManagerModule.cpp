...
void initchrmgr()
{
	...
	PyModule_AddIntConstant(poModule, "EFFECT_LEVELUP_ON_14_FOR_GERMANY", CInstanceBase::EFFECT_LEVELUP_ON_14_FOR_GERMANY );	//·¹º§¾÷ 14ÀÏ¶§ ( µ¶ÀÏÀü¿ë )
	PyModule_AddIntConstant(poModule, "EFFECT_LEVELUP_UNDER_15_FOR_GERMANY", CInstanceBase::EFFECT_LEVELUP_UNDER_15_FOR_GERMANY );//·¹º§¾÷ 15ÀÏ¶§ ( µ¶ÀÏÀü¿ë )
