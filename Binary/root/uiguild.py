...
class GuildWindow(ui.ScriptWindow):
	...
	def __MakeMemberPage(self):
		...
		for i in xrange(self.MEMBER_LINE_COUNT):
			...
			generalEnableCheckBox = CheckBox(page, 300, yPos, event, "d:/ymir work/ui/public/Parameter_Slot_00.sub")
	...
	def OnAddFighter(self, lineIndex):
		if not guild.IsMember(lineIndex):
			return
		...
		return True
		#net.SendGuildAddFighterPacket(pid)
