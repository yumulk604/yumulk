...
DWORD CPythonNetworkStream::GetEmpireCountByID(DWORD dwEmpireID)
{
	return m_dwEmpireCount[dwEmpireID];
}
...
CPythonNetworkStream::CPythonNetworkStream()
{
	...
	m_dwEmpireID = 0;
	m_dwEmpireCount[0] = m_dwEmpireCount[1] = m_dwEmpireCount[2] = m_dwEmpireCount[3] = 0;
	m_dwGuildID = 0;
