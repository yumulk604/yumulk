...
class ToolTip(ui.ThinBoard):
	...
	NO_PRICE_COLOR = 0xffC7CF00
	PRICE_COLOR = grp.GenerateColor(0.7, 0.7, 0.7, 1.0)
...
class ItemToolTip(ToolTip):
	...
	def AppendPrice(self, price):
		self.AppendSpace(5)
		if price > 0:
			self.AppendTextLine(localeInfo.TOOLTIP_BUYPRICE  % (localeInfo.NumberToMoneyString(price)), self.PRICE_COLOR)
		else:
			self.AppendTextLine("Gratuit", self.NO_PRICE_COLOR)
	...
	def AppendSellingPrice(self, price):
		if item.IsAntiFlag(item.ITEM_ANTIFLAG_SELL):			
			...
			self.AppendTextLine(localeInfo.TOOLTIP_SELLPRICE % (localeInfo.NumberToMoneyString(price)), self.PRICE_COLOR)
			self.AppendSpace(5)
		elif price == 0:
			self.AppendTextLine("Gratuit", self.NO_PRICE_COLOR)
			self.AppendSpace(5)
