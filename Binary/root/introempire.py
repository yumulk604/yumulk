...
class SelectEmpireWindow(ui.ScriptWindow):
	...
	def Close(self):
		...
		self.textBoard = None
		self.empireCount = None
		self.empireText = None
	...
	def OnSelectEmpire(self, arg):
		...
		self.empireText.SetText(localeInfo.EMPIRE_COUNT % (net.GetEmpireCountByID(arg), net.GetEmpireCountByID(0)))#arg
	...
	def __LoadScript(self, fileName):
		...
		try:
			...
			self.empireCount	= GetObject("empire_count")
			self.empireText		= GetObject("empire_text")
