...
bool CPythonSkill::RegisterSkill(DWORD dwSkillIndex, const char * c_szFileName)
{
	...
	{
		char szName[256];
		sprintf(szName, "1250description");
...

	{
		...
		sprintf(szConditionData, "1250conditiondata");
...

	{
		...
		sprintf(szAffectData, "1250affectdata");
...

	{
		...
		sprintf(szGradeData, "1250gradedata");
